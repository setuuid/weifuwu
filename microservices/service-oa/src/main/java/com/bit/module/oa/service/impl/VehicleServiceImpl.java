...
public class VehicleServiceImpl extends BaseService implements VehicleService{
	...
	@Override
	public List<VehicleExportVO> findExportVehicle(String vehicleType, String power, String plateType) {
		List<Vehicle> list = vehicleDao.findByCondition(vehicleType, power, plateType);
	 ...
	 */
	@Override
	public List<SimpleVehicleVO> findAll(String sorter){
		return vehicleDao.findAll(sorter);
	}
	/**
	 * 通过主键查询单个Vehicle
	 * @param id
