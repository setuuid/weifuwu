...
public interface VehicleApplicationDao {
	...
	List<VehicleApplicationDetail> findExportDataByCondition(VehicleApplicationQO vehicleApplicationQO);
	/**
	...
	List<VehicleApplicationDetail> findLedgerExportDataByCondition(VehicleApplicationQO vehicleApplicationQO);
}
