...
public interface VehicleApplicationService {
	 ...
	 * @return
	 */
	List<MyVehicleApplicationExportVO> findExportMyVehicleUsing(VehicleApplicationQO vehicleApplicationQO);
	/**
	 * 用车台账
	 * @param vehicleApplicationQO
	 * @return
	 ...
	 * @return
	 */
	List<HandleVehicleApplicationExportVO> findHandleApplicationExport(VehicleApplicationQO vehicleApplicationQO);
	/**
	 ...
	 * @param vehicleApplications
	 */
	void batchUpdate(List<VehicleApplication> vehicleApplications);
	/**
	...
	List<HandleVehicleApplicationExportVO> findLedgerApplicationExport(VehicleApplicationQO vehicleApplicationQO);
}
