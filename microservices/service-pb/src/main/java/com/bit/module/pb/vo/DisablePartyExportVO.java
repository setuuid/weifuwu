...
public class DisablePartyExportVO implements Serializable {
    ...
    @Excel(name = "所属党支部", width = 15, orderNum = "1")
    ...
    @Excel(name = "学历", width = 12, orderNum = "6")
    ...
    @Excel(name = "党籍状态", replace = { "正式_1", "预备_2" }, width = 13, orderNum = "10")
    ...
    @Excel(name = "停用原因", replace = {"党员去世_1", "停止党籍_2", "党员出党_3", "其它_4"}, width = 20, orderNum = "15")
