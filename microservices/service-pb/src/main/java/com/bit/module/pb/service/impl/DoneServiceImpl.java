...
import com.bit.module.pb.enums.ActionTransferEnum;
...
public class DoneServiceImpl extends BaseService implements DoneService {
	...
	public Done findOutreason(Long correlationId) {
		return doneDao.findOutreason(correlationId, TopicTypeEnum.PARTYMEMBER.getValue(), ActionPartyMemberEnum.DISABLE.getValue());
	}
