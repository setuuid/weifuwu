...
public interface PartyDueDao {
	 ...
	 * @param month
	 */
	void batchUpdate(@Param("partyDues") List<PartyDue> partyDues,
					 @Param("year") int year,
	 ...
	 * @return
	 */
    PartyDueVO findByPartyMemberIdAndMonth(@Param("memberId") String partyMemberId, @Param("month") int monthValue);
